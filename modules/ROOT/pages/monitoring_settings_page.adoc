...
* Find the instructions to install Anypoint Monitoring on an on-premises server to monitor applications running on that server. 
...
You can enable monitoring for Mule apps running on Mule 3.9.2 in the *Settings* page. 
