...
Configure tables for custom dashboards in Anypoint Monitoring. In addition to configuring properties that are common to other charts, such advanced or basic metric queries and time ranges, you can also:
...
Create or navigate to the table you plan to configure:

* If your table exists, open its configuration view:
