...
Open the table's configuration view. 

* To open the table's configuration view:
...
* To create a table in a custom dashboard, see xref:dashboard-custom-config.adoc#charts_adding[Add Charts to a Custom Dashboard].
