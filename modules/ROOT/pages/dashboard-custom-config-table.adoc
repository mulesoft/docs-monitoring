...
* <<column-styles, *Column Styles*>>: TODO
...
. Optionally:
.. In the table's <<time-range, *Time range*>> tab, set the table's overrides for the time range to capture.
.. In the <<options, *Options*>> tab, configure table fonts, coloring, spark lines, and other style settings.
