...
== Grace Period for Data Retention Prior to Decommissioning 

If your organization downgrades to a lower subscription tier (usage-based or core-based) or cancels your subscription, your data is removed according to this schedule:
