= Monitoring Metrics from Dashboards
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

In https://anypoint.mulesoft.com/monitoring[US] and https://eu1.anypoint.mulesoft.com/monitoring[EU] clouds, use built-in and custom dashboards in Anypoint Monitoring to get visibility into Mule apps and APIs deployed to your environments (for example, Production, Sandbox, or Design).
...
* xref:api-dashboard.adoc[API Analytics Dashboard]
