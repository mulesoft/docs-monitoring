...
Open the graph's configuration view.

* To open the graph's configuration view:
...
. Click the text graph's image:more-menu-vert-ellipsis.png["",15,15] (*More menu*), and select *Configure*.
* To create a graph in a custom dashboard, see xref:dashboard-custom-config.adoc#charts_adding[Add Charts to a Custom Dashboard].
