...
Configure time-series data in a graph. A custom dashboard graph in Anypoint Monitoring displays metrics for a Mule app or API.
...
. *Advanced Mode*: Switch for enabling <<mode_advanced, advanced>> graph configurations
+
...
//TODO: VERIFY Point Radius and Line Width -- Claude thinks there's a contradition saying Lines relate to point
