...
:description: Configure graph charts in MuleSoft Anypoint Monitoring custom dashboards, including metrics, axes, display options, and advanced multi-metric configurations.
:keywords: MuleSoft, Anypoint Monitoring, custom dashboards, graph charts, dashboard visualization, metrics charts, advanced mode, multi-metric graphs
...
+
Advanced mode supports complex configurations with up to 25 queries.
