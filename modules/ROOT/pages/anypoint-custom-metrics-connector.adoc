...
== Example: Using DataWeave to Send Custom Metrics

This example uses `custom-metrics:send` to submit custom metric values defined as variables in `ee:transform` and `ee:set-variable` components. 
