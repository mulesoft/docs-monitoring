...
=== Refrain from Using Restricted Keywords

The database we use to store the metrics has the following keywords restricted. They cannot be use as "dimensionName" or "factName" while using custom metric connector.
