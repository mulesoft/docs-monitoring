...
From *Monitoring*, click *Custom Metrics* to locate *Anypoint Monitoring Custom Metrics Connector*. Alternatively, you can search for the connector in Anypoint Exchange. 
