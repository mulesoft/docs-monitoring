...
From Anypoint Monitoring, click *Custom Metrics* to locate *Anypoint Monitoring Custom Metrics Connector*. Alternatively, you can search for the connector from Anypoint Exchange. 
