...
:description: Use the Anypoint Custom Metrics connector to send custom operational and business metric values from Mule apps to Anypoint Monitoring for visualization in Anypoint Insights and custom dashboards.
