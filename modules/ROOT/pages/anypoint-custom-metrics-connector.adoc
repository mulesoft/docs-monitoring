...
[IMPORTANT]
To use a custom metric, you must add it to a chart within two days of creating the metric. After two days, the name no longer appears in the list of metrics available as a *metric_name* value. Custom metrics appear in the dropdown after an app produces logs on the custom metric. 
