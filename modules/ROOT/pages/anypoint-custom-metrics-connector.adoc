...
[IMPORTANT]
To use a custom metric, you must add it to a chart configuration within two days of creating the metric. After two days, the metric name no longer appears in the list of *metric_name* values in the advanced chart configuration UI. Custom metrics appear in the dropdown after an app produces logs on the custom metric. 
