...
+
If you use the *Send Custom Metric* operation of the Anypoint Monitoring Custom Metrics Connector with a new metric name changes, the old metric name continues to appear in the *Custom Metrics* tab. 
