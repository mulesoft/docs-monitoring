...
+
image::custom-metric-example-flow.png["Example app flow in Studio with Custom Metrics Connector Send Custom Metrics source, a Logger component, and Salesforce and Amazon S3 connector operations"]
