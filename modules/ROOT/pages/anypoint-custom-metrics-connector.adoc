...
+
image::custom-metric-example-flow.png["Example app flow in Studio with custom metrics connector Send Custom Metrics trigger, a logger component, and Salesforce and AmazonS3 connector operations"]
...
+
image::custom-metrics-connector-config.png["Send Custom Metrics trigger general configuration properties form with example values for contextual information and measurements"]
+
