...
Open the singlestat's configuration view.

* To open the singlestat's configuration view:
...
* To create a singlestat chart in a custom dashboard, see xref:dashboard-custom-config.adoc#charts_adding[Add Charts to a Custom Dashboard].
