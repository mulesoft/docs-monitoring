//TODO_TODO_TODO title! Generate/Enable Real-time Logs for Apps and APIs
= Anypoint Monitoring Log Points

//TODO_TODO_TODO "Permissions control allows"?
