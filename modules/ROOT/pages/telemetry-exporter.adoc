...
* Create a configuration for your app that specifies the type of data Anypoint Platform exports and which business group and environment allows content to be exported from your app.
...
The Telemetry Exporter enables you to create connections with most third-party observability and analytics platforms that:
