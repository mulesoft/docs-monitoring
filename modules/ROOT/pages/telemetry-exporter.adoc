...
. In the *Connection Details* page, edit each field you want to change and click *Next*.
. In the *Authentication* page, edit each field you want to change and click *Test Connection*. 
