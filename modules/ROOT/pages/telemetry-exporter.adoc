...
* Access information for your third-party observability platform, including the endpoint that supports OpenTelemetry.
...
* *Endpoint URL*: Endpoint supporting OpenTelemetry that enables external connections to your third-party observability platform (see <<third-party-support>>). The location of this endpoint depends on your platform. 
. Click *Next*.
