...
The Telemetry Exporter enables you to export xref:access-management::audit-logging.adoc[_audit logs_] and trace data from CloudHub 2.0 apps to third-party observability and analytics apps, such as Azure Monitor, Splunk HEC, and OpenTelemetry compliant tools. Trace data can only be exported from CloudHub 2.0 apps. 

When exporting trace data from Telemetry Exporter, the data must come from apps running on CloudHub 2.0. 
