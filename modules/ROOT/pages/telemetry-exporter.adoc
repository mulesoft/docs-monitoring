...
The Telemetry Exporter enables you to export xref:access-management::audit-logging.adoc[_audit logs_] and trace data from CloudHub 2.0 apps to third-party observability and analytics apps, such as Azure Monitor and Splunk HEC.
