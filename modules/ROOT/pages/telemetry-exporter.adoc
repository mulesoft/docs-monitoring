...
The Telemetry Exporter feature enables you to export xref:access-management::audit-logging.adoc[_audit logs_] and _trace data_ to third-party observability and analytics apps, such as Datadog and Splunk.

To use Telemetry Exporter, you must create a _connection_ with a third-party app to authorize Anypoint Platform to share data. You must then create a _configuration_ to specify the types of data Anypoint Platform exports as well as the frequency of data transfers. You can also edit and delete connections and configurations.

== Before You Begin

Before you configure Telemetry Exporter, ensure that you have:
...
+
The new connection appears in the *Connections* tab in the *Telemetry Exporter* page.
