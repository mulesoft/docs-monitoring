...
* Create a configuration that specifies the type of data Anypoint Platform exports and which business group and environment allows content to be exported to connections.
