...
* Create a connection with a third-party app to authorize Anypoint Platform to share data. See also, <<third-party-support>>.
...
* *Endpoint URL*: Endpoint supporting OpenTelemetry that enables external connections to your third-party app (see <<third-party-support>>). The location of this endpoint depends on your app. 
. Click *Next*.
