...
For information about chart data collection, including charts identified as *Other*, see xref:app-dashboards.adoc#endpoint-operation-metrics[How Endpoint and Operation Use Metrics Are Gathered].
