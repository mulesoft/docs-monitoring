...
The enhanced metrics view includes detailed information about your APIs, and charts are sorted into dashboards based on the type of data displayed. Currently, enhanced metrics are available if you are using Mule Runtime version 3.9.3, 3.94, 4.2.1, or 4.2.2.
