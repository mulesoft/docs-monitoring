...
[NOTE]
For xref:index.adoc#plans-legacy[Gold and Platinum subscriptions], Anypoint Monitoring retains API analytics metrics data for 30 days. API Manager retains API analytics metrics data for 30 days.
