...
| xref:api-analytics-dashboard.adoc#overview-charts[Overview] a|
...
| xref:api-analytics-dashboard.adoc#requests-charts[Requests] a|
...
| xref:api-analytics-dashboard.adoc#policies-charts[Policies] a|

* Requests
* Policy Violations by Outcome
* Policy Violations by Violation ID

| xref:api-analytics-dashboard.adoc#failures-charts[Failures] a|
...
| xref:api-analytics-dashboard.adoc#performance-charts[Performance] a|

* Requests by Performance (line chart)
* Requests by Performance (table)
* Slow Requests (requires Titanium)

| xref:api-analytics-dashboard.adoc#client-applications-charts[*Client Applications*] a|
