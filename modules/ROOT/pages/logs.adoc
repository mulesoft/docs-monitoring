...
+
image::log-filter-timestamp.png["Filter query example"]
+
...
image::log-expanded.png["Expanded log message"]
...
+
image::logs-view-extended.png["Extended logs"]
...
+
image::logs-set-surrounding.png["Surrounding logs view"]
...
image::log-filter-add-field.png["Log filter column addition"]
