...
When you search for logs for APIs deployed using the Flex Gateway, use the *Application* filter. Use the *App ID* field identify the instance.
...
NOTE:
When you use the *Application* filter, the results include APIs deployed using the Flex Gateway.
