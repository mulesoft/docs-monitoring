...
In addition to logging through xref:runtime-manager::logs.adoc[Runtime Manager], you can use Anypoint Monitoring to aggregate your log files so that you can manage, search for, filter, and analyze your logs. These features support:
