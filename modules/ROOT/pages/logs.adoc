...
[[log-search]]
The Log Search UI varies by Anypoint Platform instance. 

* <<log-search-comm-cloud>>
* <<log-search-hyperforce>>

[[log-search-comm-cloud]]
== Search Logs from CA and JP Instances of Anypoint Platform
...
[[log-search-hyperforce]]
== Search Logs from EU and US Instances of Anypoint Platform
