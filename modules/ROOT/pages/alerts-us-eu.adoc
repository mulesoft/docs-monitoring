= Getting Alerts in Anypoint Monitoring (US and EU Clouds)
...
In the https://anypoint.mulesoft.com/monitoring[US] and https://eu1.anypoint.mulesoft.com/monitoring[EU] Clouds, you can create these types of alerts from Anypoint Monitoring:
