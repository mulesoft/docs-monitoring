...
There are several types of alerts. From the *Alerts* page in Anypoint Monitoring, you can create xref:alerts-config.adoc#basic-alerts[basic alerts] or link out to alerts for API and Runtime alerts.
