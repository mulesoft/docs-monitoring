...
If you have a Titanium subscription, the limit is 100 basic alerts plus 50 alerts per vCore. For complete details about subscriptions, contact your customer support representative. See also https://www.mulesoft.com/anypoint-pricing[Anypoint Platform pricing].
