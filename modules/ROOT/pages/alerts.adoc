...
Create basic and custom dashboard alerts in Anypoint Monitoring.

* xref:basic-alerts.adoc[Basic alerts] for servers, Mule apps, and APIs

** EU and US Anypoint Platform instances:
+
image::intro-alerts.png["Alerts in Anypoint Monitoring"]

** Japan (JP) and Canada (CA) Anypoint Platform instances:
+
TODO_TODO: IMAGE_HERE
//image::alerts-hyperforce.png["Alerts in Anypoint Monitoring instances in Hyperforce regions"]

* xref:custom-dashboard-alerts.adoc[Custom dashboard alerts] for infographics in custom dashboards in Anypoint Monitoring
...
include::partial$include-alert-state.adoc[]

| 
//TODO: VERIFY THESE (ARE THEY CHANGING?)
* *All statuses*:
Lists all alerts
