...
The number of alerts allocated to your company depends on your pricing model. Alert counts differ by alert type:

* For API alerts, only active alerts count toward the alert limit. Paused alerts do not count toward the limit.
* For MuleSoft apps and for servers, server groups, or clusters, all alerts count toward the alert limit, both active and paused.
