...
You can create and configure as many custom dashboards as you need. There are two levels of dashboard configuration:
...
You can export app data to a CSV file, which you can then use in other applications. 
