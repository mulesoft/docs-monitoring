...
. In *Anypoint Monitoring*, click *Custom dashboards* from the sidebar.
+
...
. From *Custom Dashboards*, open a custom dashboard.
. From the dashboard's header, click image:more-menu-vert-ellipsis.png["",15,15] (*More menu*), and select <<dup_delete_dashboard, Delete>>.
