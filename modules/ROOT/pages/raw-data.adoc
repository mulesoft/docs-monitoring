...
You can use Anypoint Monitoring to download archived log data (raw data) collected on Mule apps that are running in CloudHub. This data is helpful for security, compliance, or other purposes where you need to examine or collect your warehoused data.
