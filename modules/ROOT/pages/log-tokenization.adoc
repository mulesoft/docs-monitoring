...
[NOTE]
You must have the *Manage Policies* permission to detokenize values. See 2.x@api-manager::environment-permission-task.adoc[Granting Permission to Access an Environment]
