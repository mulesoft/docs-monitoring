...
Monitoring Administrator:: Allows users to view, create, modify, and delete all content in Anypoint Monitoring.
Monitoring Viewer:: Allows users to view but not modify content in Anypoint Monitoring.

// Data Exporter Configurations Manager
// Data Exporter Administrator
