...
Anypoint Monitoring has two product-specific permissions that control access to assets within Anypoint Monitoring:
...
For example, a user who has the Anypoint Monitoring Administrator permission who wants to modify Anypoint Monitoring data for an on-premises app also needs the Read Applications permission in the same environment as the app for which they want to view Anypoint Monitoring data.
