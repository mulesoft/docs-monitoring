...
=== Charts with Endpoints

Charts that contain endpoint metrics sort the available endpoints in a menu.
The requested time period for the results shown in the endpoint charts can include multiple grouping intervals because the data is processed in intervals of time.
