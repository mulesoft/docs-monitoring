...
Salesforce Requests::
The average number of Anypoint Connector for Salesforce (Salesforce Connector) requests, grouped by operation in automatic intervals. For more information about which operations appear, see the section about xref:monitoring::app-dashboards.adoc#endpoint-operation-metrics[endpoint and operation data collection].
...
Salesforce Failures::
The average number of Anypoint Connector for Salesforce (Salesforce Connector) requests failures, grouped by operation in automatic intervals.

Database Requests::
The average number of Anypoint Connector for Database (Database Connector) requests, grouped by operation in automatic intervals. For more information about which operations appear, see the section about xref:monitoring::app-dashboards.adoc#endpoint-operation-metrics[endpoint and operation data collection].

Database Response Time::
The average response time of Anypoint Connector for Database (Database Connector) requests, grouped in automatic intervals.

Database Failures::
The average number of Anypoint Connector for Database (Database Connector) requests failures, grouped by operation in automatic intervals. For more information about which operations appear, see the section about xref:monitoring::app-dashboards.adoc#endpoint-operation-metrics[endpoint and operation data collection].

HTTP Requests::
The average number of HTTP connector requests, grouped by operation in automatic intervals. For more information about which operations appear, see the section about xref:monitoring::app-dashboards.adoc#endpoint-operation-metrics[endpoint and operation data collection].

HTTP Response Time::
The average response time of HTTP connector requests, grouped in automatic intervals.

HTTP Failures::
The average number of HTTP connector requests failures, grouped by operation in automatic intervals. For more information about which operations appear, see the section about xref:monitoring::app-dashboards.adoc#endpoint-operation-metrics[endpoint and operation data collection].
