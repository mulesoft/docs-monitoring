...
The requested time period for the results shown in the endpoint charts may include multiple grouping intervals because the data is ingested in intervals of time.
