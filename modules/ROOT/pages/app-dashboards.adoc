...
Inbound Response Time by Flow::
The average inbound response time.

Outbound Response Time by Flow::
The average outbound response time.

Inbound Request Volume by Flow::
The average number of inbound requests.

Outbound Request Volume by Flow::
The average number of outbound requests.

Failures by Flow::
The average number of failed inbound requests.

Slow Inbound Requests by Flow::
The average number of inbound requests whose response time is greater than 1000 ms.

Slow Outbound Requests by Flow::
The average number of outbound requests whose response time is greater than 1000 ms.

Inbound Response Time by Flow::
The average, minimum, and maximum inbound response time.

Outbound Response Time by Flow::
The average, minimum, and maximum outbound response time.
...
Failures by Flow::
The average number of inbound failed requests
