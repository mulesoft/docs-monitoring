...
. From the sidebar, click *Built-in dashboards*. 
...
Setup requirements change based on your app deployment. Some deployment types require you to enable header injection or modify how {visualizer} collects data. For more information, see the documentation for each deployment type:
...
You can click *Metrics* to see statistics, such as average response time and failures, related to the app you selected. For more information about metrics in {visualizer}, see xref:visualizer::troubleshooting-visualization.adoc#choosing-your-metric[Choosing Your Metric].
