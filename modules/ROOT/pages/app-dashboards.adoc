...
* Inbound - Total requests by type
* Inbound - Average response time
* Inbound - Mule messages
* Outbound - Total requests by type
...
* Total inbound requests by type
...
* Slow request count by endpoint: Total calls in which response time is greater than 1000 ms
...
* Total outbound requests by type
* Average response time
