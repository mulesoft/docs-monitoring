...
image::dashboard-built-in-info.png["Deployment info for an app in a built-in dashboard"]

The graphs and tables in built-in dashboards support many metrics, including application metrics. The *Overview* tab provides overall measures. You can view more granular application metrics through *Inbound*, *Outbound*, *Flows*, *Connectors*, *Performance*, *Failures*, and other provided tabs.
