...
The sum of outbound requests grouped by connector type.
...
Mule Messages::
The number of Mule messages processed in the runtime.
...
Garbage Collection Count::
The average number of collections that have occurred, grouped by worker.

Garbage Collection Time::
The average amount of JVM garbage collection time, grouped by worker.

ParNew Collection Count::
The average number of ParNew garbage collections, grouped by worker.

ParNew Collection Time::
The average amount of ParNew garbage collection time, grouped by worker.

Classes Loaded::
The average number of loaded classes, grouped by worker.

Classes Loaded Total::
The number of classes loaded since JVM start, grouped by worker.

Classes Unloaded::
The average number of classes unloaded since JVM start, grouped by worker.
...
JVM Uptime::
The time since JVM started, grouped by worker.
...
Operating System Swap Space::
The amount of memory the system is swapping, grouped by worker.
