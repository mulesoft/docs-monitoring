...
.10+| <<overview-charts>> 
    ...
    | Outbound - Total Requests by Response Type | Requests tab: Inbound Request volume - choose group by Response type
    | Outbound - Average Response Time | N/A
...
.10+| <<inbound-charts>> 
    | Inbound - Total Requests by Response Type | Requests tab: Inbound Request Volume - choose group by Response type 
    | Inbound - Average Response Time | N/A 
    | Inbound - Average Response Time by HTTP Endpoint | Requests tab: Request Latency by Endpoint table, choose group by Inbound
    | Inbound - Response Time by HTTP Endpoint | Requests tab: Request Latency by Endpoint table, choose group by Inbound
    | Inbound - Total Requests by Endpoint | TODO 
    | Inbound - Response Time graphs (99, 90, 75, and 50 percentiles) | Overview tab: Inbound Request Latency chart 
    | Inbound - Total Failed Requests (TODO: Outbound - Failure Total Request Count) | Errors tab: Failed Outbound Request Volume chart
//TODO
...
.10+| <<outbound-charts>>
    ...
    | Outbound - Total Failed Requests | TODO 
//TODO
//include::reuse::partial$billing/pricing.adoc[tag=chartAvailability]
    | Outbound - HTTP Ports | TODO 
    | Outbound - Operations | TODO 
    | Outbound - HTTP Protocols | TODO 
    | Outbound - Endpoints | TODO 

.14+| <<flows-charts>>
//TODO
//include::reuse::partial$billing/pricing.adoc[tag=chartAvailability]
    | Inbound - Response Time by Flow | Flows tab 
    | Outbound - Response Time by Flow | Flows tab 
    | Inbound - Requests by Flow | Flows tab 
    | Outbound - Requests by Flow | Flows tab 
    | Failures by Flow | Flows tab 
    | Inbound - Slow Requests by Flow | N/A
    | Outbound - Slow Requests by Flow | N/A
    | Inbound - Response Time by Flow | Flows tab
    | Outbound - Response Time by Flow | Flows tab
    | Inbound - Requests by Flow | Flows tab
    | Outbound - Requests by Flow | Flows tab
...
.8+| <<performance-charts>>
    ...
    | Inbound - Average Response Time | TODO 
    | Inbound - Response Time by HTTP Endpoint | TODO 
    | Inbound - Response Time graphs (99, 90, 75, and 50 percentiles) | TODO 
    | Outbound - Average Response Time | TODO 
    | Outbound - Response Time by Endpoint | TODO 
    | Outbound - Response Time graphs (99, 90, 75, and 50 percentiles) | TODO 

.9+| <<failures-charts>>
    | Errors | TODO
    | Inbound - Total Failed Requests | TODO
    | Outbound Total Failed Requests | TODO
    | Inbound - Total Requests by Response Type | TODO
    | Outbound - Total Requests by Response Type | TODO
    | Inbound - Failure Response Time by Endpoint | TODO
    | Inbound - Total Failed Requests by Endpoint | TODO
    | Outbound - Failure Response Time by HTTP Endpoint | TODO
    | Outbound - Total Failed Requests by HTTP Endpoint | TODO

.15+| <<jvm-charts>>
    | Old Gen GC Count | TODO
    | Old Gen GC Time | TODO
    | Young Gen GC Count | TODO
    | Young Gen GC Time | TODO
    | Classes (Loaded, Loaded Total, Unloaded) | TODO
    | Heap (Committed, Used) | TODO
    | Thread Count | TODO
    | JVM Uptime | TODO: TBD (PENDING WORK?)
    | Eden Space graphs (Used, Max, Init, and Committed) | TODO
    | Survivor Space graphs (Used, Max, Init, and Committed) | TODO
    | Metaspace graphs (Used, Max, Init, and Committed) | TODO
    | Code Cache graphs (Used, Max, Init, and Committed) | TODO
    | Compressed Class Space graphs (Used, Max, Init, and Committed) | TODO
    | Old Gen Mem graphs (Used, Max, Init, and Committed) | TODO
//TODO
//include::reuse::partial$billing/pricing.adoc[tag=chartAvailability]
    | Committed Virtual Memory | TODO

.8+| <<infrastructure-charts>>
    | JVM - CPU % Utilization .8+| N/A (not available at this time)
    | JVM - Heap Used
