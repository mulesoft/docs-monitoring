...
The graphs and tables in built-in dashboards support many metrics, including application metrics. The *Overview* tab provides overall measures. You can view more granular application metrics through <<chart-reference, additional tabs>>.
...
//TBD IF STILL TRUE:
//ALSO REQUIRED USE OF Unified Agent? WHAT IS THAT?
...
//TBD IF STILL TRUE:
//ALSO REQUIRED USE OF Unified Agent AND Titanium or Advanced? WHAT IS THAT?
