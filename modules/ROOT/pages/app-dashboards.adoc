...
[%header,cols="1,4,4"]
|===
| Built-In Dashboards | Charts | Available in Anypoint Insights
.10+| <<overview-charts>> 
    | Mule Messages | Overview tab: Mule Messages
    | Average Response Time | N/A
    | Errors | Overview tab: Failed Inbound Request Volume
...
.12+| <<inbound-charts>> 
    ...
    | Inbound - Average Response Time by HTTP Endpoint .5+| Requests tab: Request Latency by Endpoint table, choose group by Inbound
    ...
    | Inbound - Response Time graphs (99, 90, 75, and 50 percentiles) | Overview tab: Inbound Request Latency chart 
    | Inbound - Total Failed Requests (TODO: Inbound - Failure Total Request Count) | Overview tab: Failed Inbound Request Volume 
//TODO
...
.10+| <<outbound-charts>>
    | Outbound - Total Requests by Response Type | Requests tab: Outbound Request Volume - choose group by Response type 
    | Outbound - Average Response Time | N/A (not available)
    | Outbound - Average Response Time by HTTP Endpoint | Requests tab: Request Latency by Endpoint - choose group by Outbound 
    | Outbound - Total Requests by HTTP Endpoint | Requests tab: Request Latency by Endpoint - choose group by Outbound 
    | Outbound - Response Time graphs (99, 90, 75, and 50 percentiles) | Requests tab: Outbound Request Latency chart 
...
//TODO
//include::reuse::partial$billing/pricing.adoc[tag=chartAvailability]
    | Inbound - Response Time by Flow .5+| Flows tab 
...
include::reuse::partial$billing/pricing.adoc[tag=connectorTabAvailability]
    ...
    | Connector Message Volume .35+| Connectors tab 
...
.8+| <<performance-charts>>
    ...
    | Inbound - Average Response Time | Overview tab: Inbound Request Latency (avg is one of the chart series) 
    | Inbound - Response Time by HTTP Endpoint | Requests tab: Request Latency by Endpoint table, choose group by Inbound 
    | Inbound - Response Time graphs (99, 90, 75, and 50 percentiles) | Overview tab: Inbound Request Latency chart 
    | Outbound - Average Response Time | N/A (not available) 
    | Outbound - Response Time by Endpoint | Requests tab: Request Latency by Endpoint - choose group by Outbound 
    | Outbound - Response Time graphs (99, 90, 75, and 50 percentiles) | Requests tab: Outbound Request Latency chart 

.9+| <<failures-charts>> TODO: TBD "All charts in Failures tab are duplicates. FIND AND IDENTIFY WHERE THEY ARE, NAMES NOT FOUND ELSEWHERE 
    | Errors | Overview tab: Failed Inbound Request Volume
...
.15+| <<jvm-charts>>
    ...
    | Classes (Loaded, Loaded Total, Unloaded) | Classes Loaded, Classes Loaded Total, Classes Unloaded
    | Heap (Committed, Used) | Heap Committed, Heap Usage
    | Thread Count | Thread Count
    | JVM Uptime | N/A (not available at this time)
    | Eden Space graphs (Used, Max, Init, and Committed) | Par Eden Space
    | Survivor Space graphs (Used, Max, Init, and Committed) | Survivor Space
    | Metaspace graphs (Used, Max, Init, and Committed) | Metaspace
    | Code Cache graphs (Used, Max, Init, and Committed) | Code Cache 
    | Compressed Class Space graphs (Used, Max, Init, and Committed) | Compressed Class Space
    | Old Gen Mem graphs (Used, Max, Init, and Committed) | TODO: Split into Tenured Gen and G1 Old Gen charts *DETERMINE IMPLEMENTATION*
//TODO
//include::reuse::partial$billing/pricing.adoc[tag=chartAvailability]
