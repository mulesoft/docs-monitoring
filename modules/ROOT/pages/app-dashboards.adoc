...
Setup requirements change based on your app deployment. Some deployment types require you to enable header injection or modify how data is collected. For more information, see the documentation for each deployment type:
