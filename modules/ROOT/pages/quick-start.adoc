...
:description: Get started with MuleSoft Anypoint Monitoring to view metrics, logs, traces, and alerts for Mule apps, APIs, and agentic assets across your Anypoint Platform environments.
:keywords: MuleSoft, Anypoint Monitoring, getting started, quick start, Mule app monitoring, API monitoring, metrics, logs, traces, alerts
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Anypoint Monitoring provides metrics, logs, traces, and alerts for Mule apps, APIs, and agentic assets deployed across your Anypoint Platform environments.
...
. From the sidebar, you can find xref:index.adoc#features[Anypoint Monitoring features].
