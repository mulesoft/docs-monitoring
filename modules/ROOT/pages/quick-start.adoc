...
If you are using a Mule 4 version that is older than version 4.1.5, you cannot use built-in API metrics.

Versions 3.8.6 or older are not supported. Additionally, all -AM runtime versions are deprecated.
