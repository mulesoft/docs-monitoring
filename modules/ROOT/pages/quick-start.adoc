...
:description: Get started with Anypoint Monitoring to view metrics, logs, traces, and alerts for Mule apps, APIs, and agentic assets across your Anypoint Platform environments.
