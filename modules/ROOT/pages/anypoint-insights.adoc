...
Anypoint Insights uses <<metrics-api, Anypoint Monitoring Metrics API>> to query data for charts. Data aggregation and retention limits in Anypoint Insights are derived from the service that supports the Metrics API. 
