...
. App associated with this details page and a dropdown for opening the detail page for another app or API in any environment
...
Get information on the charts and visualization available for the app:
...
. API associated with this details page and a dropdown for opening the detail page for another API or app in any environment
. Tabs containing charts and visualizations for different types of metrics on the API
. Navigation for switching to the traditional built-in dashboard for this API from Anypoint Insights
