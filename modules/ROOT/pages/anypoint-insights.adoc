...
Anypoint Insights uses the <<metrics_api, Metrics API>> to collect data for charts. Data aggregation and retention limits in Anypoint Insights are derived from the service that supports the Metrics API. 
...
Anypoint Monitoring charts aggregate data into data points along a horizontal *Time* axis. If the units time for data in your charts are larger or smaller than you require, try narrowing or expanding the time range that your charts capture. Alternatively, you can use the <<metrics-api, Metrics API>> to aggregate data within the API's limits.
...
Anypoint Insights uses the Metrics API to collect data for charts. You can use this API to collect metrics data for your needs. 

Data aggregation periods depends on the age of the data:

* Data less than or equal to 7 days old is aggregated into 1-minute segments. 
* Data over 7 days old is aggregated into 5-minute segments. 

//TODO: FILL IN TODO IN URL
To use the API and get information about data retention, see the API documentation on Anypoint Exchange: https://anypoint.mulesoft.com/exchange/TODO_TODO

//TODO: QAX URL (don't use): https://qax.anypoint.mulesoft.com/exchange/6046b96d-c9aa-4cb2-9b30-90a54fc01a7b/metrics-api/minor/1.0/pages/home/ //
//TODO: IF URL UNAVAILABLE, perhaps we could just put search URL https://anypoint.mulesoft.com/exchange/?search=%27Anypoint%20Monitoring%20Metrics%20API%27&show=all-org&sort=score Should be the first hit once API is up on the site.