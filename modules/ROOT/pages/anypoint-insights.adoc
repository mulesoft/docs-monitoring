...
= Get Aggregated Metrics and Trends with Anypoint Insights

Get metrics, trends, and other data across your CloudHub and CloudHub 2.0 deployments with Anypoint Insights, in Anypoint Monitoring. 

* View aggregated performance and error data at a glance.
* Review key metrics about the health of individual apps and APIs.
+
