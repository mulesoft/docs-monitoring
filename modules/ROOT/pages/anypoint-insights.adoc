...
Anypoint Insights uses <<metrics-api, Anypoint Monitoring Metrics API>> to collect data for charts. Data aggregation and retention limits in Anypoint Insights are derived from the service that supports the Metrics API. 
...
Anypoint Insights uses Anypoint Monitoring Metrics API to collect data for charts. You can use this API to collect metrics data for your needs. 
