...
Anypoint Insights uses <<metrics_api, Anypoint Monitoring Metrics API>> to collect data for charts. Data aggregation and retention limits in Anypoint Insights are derived from the service that supports the Metrics API. 
...
* Data less than or equal to 7 days old is available in 1-minute segments. 
