...
Anypoint Insights uses the Metrics API to collect data for charts. You can use this API to collect metrics data for your needs. Documentation of this API is available on Anypoint Exchange. 
