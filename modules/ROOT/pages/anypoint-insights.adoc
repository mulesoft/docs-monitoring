...
. Navigation for switching to the alternative, built-in dashboard for this app, and for managing the app in Runtime Manager
...
. Navigation for switching to the alternative, built-in dashboard for this API from Anypoint Insights
