...
Use Anypoint Monitoring Metrics API to access metrics that Anypoint Monitoring exposes. The documentation for this API is available on Anypoint Exchange. 
//TODO: See ADD_URL_TO_API_ON PROD EXCHANGE_ 
