= Get Performance Data with Insights

Use *Insights* in Anypoint Monitoring to get data on the performance of apps and APIs (_entities_) within an environment of a business group:

 * View performance metrics and trends across a business group.
 * Review key metrics about the health of specific entities in a business group.
...
//TODO: WHICH view PERMISSIONS EXACTLY? Unclear from list here:
// https://docs.mulesoft.com/access-management/permissions-by-product#runtime-manager
...
+
//TODO: What does "in the selected environment configured in your profile" mean?
*Anypoints Insights* provides a summary of data for entities in an active business group and in the selected environment configured in your profile.
