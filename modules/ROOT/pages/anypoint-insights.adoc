...
Anypoint Insights uses <<metrics-api, Anypoint Monitoring Metrics API>> to query for data that appears in charts. Data aggregation and retention limits in Anypoint Insights are derived from the service that supports the Metrics API. 
...
Monitor and adjust settings of charts that use your organization's custom metrics for a Mule application. 

====== Before You Begin

Meet subscription tier and Mule runtime version requirements:

The *Custom Metrics* tab for an application appears in Anypoint Insights only if your organization has the Anypoint Integration Advanced package or a Titanium subscription to Anypoint Platform and the application you selected is running on a supported version of Mule. 

====== Create Custom Metrics

To create custom metrics, use the Anypoint Custom Metrics Connector in your application flow to collect metrics for your business and operational needs. After you deploy your application, your defined custom metrics charts appear in this tab. For guidance using the Anypoint Custom Metrics Connector, see xref:monitoring::anypoint-custom-metrics-connector.adoc[].
...
To adjust the custom metrics settings of a Mule application chart in Anypoint Insights:

. From a Mule application listed in Anypoint Insights, click the *Custom Metrics* tab.
...
//TODO: LABELED SCREENSHOT API PAGE
