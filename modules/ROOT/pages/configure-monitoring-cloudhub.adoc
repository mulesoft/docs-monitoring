...
:description: Configure MuleSoft Anypoint Monitoring for Mule apps deployed to CloudHub and CloudHub 2.0, including supported Mule runtime versions and path normalization settings.
...
Enable and configure Anypoint Monitoring for Mule apps deployed to CloudHub. For CloudHub 2.0, Anypoint Monitoring is enabled by default.
