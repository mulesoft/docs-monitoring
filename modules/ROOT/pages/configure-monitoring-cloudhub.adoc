...
Anypoint Monitoring images (for example, 3.9.1-AM) receive the latest patch updates once per month, while the non-AM images receive patch updates as soon as they are available. If your production environment requires a Mule runtime engine patch, you should switch to a non-AM runtime.
