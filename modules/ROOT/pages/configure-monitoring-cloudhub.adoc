...
* Anypoint CLI with continuous integration and delivery (CI/CD)
...
. Select the application you want to monitor from the list of applications. +
...
=== Enable Monitoring by Redeploying an App using the Anypoint CLI
