...
CloudHub 2.0: Anypoint Monitoring is enabled by default for Mule apps deployed to CloudHub 2.0. For information about path normalization in CloudHub 2.0 and CloudHub, see <<normalize-path>>.
