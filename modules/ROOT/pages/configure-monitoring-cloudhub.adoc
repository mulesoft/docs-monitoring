...
== Enable Monitoring by Default for Newly Deployed Apps
...
You can enable monitoring for Mule apps running on non-AM versions of Mule by using:

* Anypoint Monitoring *Settings* for the application
* Runtime Manager *Settings* age for the application
* Anypoint CLI property during continuous integration and delivery (CI/CD)

For supported versions of Mule, see xref:configure-monitoring-cloudhub.adoc[Configure Anypoint Monitoring for Mule Apps].

=== Enable Monitoring for a running Application in Monitoring Settings
...
=== Enable Monitoring for a running Application in Runtime Manager Settings
...
=== Enable Monitoring for CI/CD Deployments using the Anypoint CLI
