...
== Enable Monitoring in Anypoint Monitoring Settings

Use the *Settings* page in Anypoint Monitoring to enable or disable apps deployed to CloudHub and running on Mule:
