...
For an accurate impact analysis specific to your application, MuleSoft recommends that you test and estimate any performance impact in your pre-production environment prior to enabling monitoring in your production environment.
