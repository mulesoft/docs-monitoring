...
You can configure Anypoint Monitoring to enable monitoring by default for any newly deployed apps to CloudHub. When you enable the *Enable Anypoint Monitoring for newly deployed CloudHub applications* check box, any Mule app that you deploy to CloudHub has monitoring enabled by default. 
