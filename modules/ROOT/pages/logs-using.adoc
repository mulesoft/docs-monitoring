...
[NOTE]
When there are many predefined filters available, you can select *See More* to further filter your results. The *See More* list displays the first five results of the most recent 500 log entries.
