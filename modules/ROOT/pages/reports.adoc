...
* Memory Utilization: The amount of the application's total heap memory used by the JVM.
* Total Memory: The total size of the application's memory.
* Memory Pressure: The percentage of the memory used (the difference between memory used and memory total).
+
