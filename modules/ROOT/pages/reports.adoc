...
[NOTE]
For applications running on stand-alone runtime i.e., Hybrid environment, Datas are shown only for Requests, Performance and Failures tabs. CPU and Memory Utilization data are not shown for Hybrid applications.
