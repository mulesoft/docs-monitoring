...
* Switch environments.
* Select the business group scope.
...
// this screenshot will be updated.
...
+
To view other reports, click the corresponding tab for the report to view. From any report tab, you can click the app name to view statistics for that app on its corresponding built-in dashboard.

You can also choose whether to display reports from your current business group or all business groups in your organization. By default, you can see reports only from your current business group. If you choose to see reports from all business groups, you can view reports only if you have access to their corresponding business groups. 
