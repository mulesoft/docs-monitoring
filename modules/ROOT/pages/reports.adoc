...
== About Reports
Reports allow you to view a list apps of running in an environment. The reports display information about overall performance and behavior across all the apps in the environment. These reports can help you identify app performance and availability problems across the environment so you can better maintain the expected level of service for your apps.

From any of the *Reports* tabs, you can:

* Navigate to reports that display information:
** Requests reports, Performance reports, and Failures reports are available for all deployment types.
** CPU Utilization reports and Memory Utilization reports are available only for CloudHub deployments.
* Switch environments.
