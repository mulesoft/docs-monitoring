...
View reports on apps running in an environment. The reports display information about overall performance and behavior across all the apps in the environment. These reports can help you identify app performance and availability problems across the environment so you can better maintain the expected level of service for your apps.

//TODO: REPLACE WITH UPDATED IMAGE FOR INDIA or other HYPERFORCE CLOUDS WHEN AVAILABLE (5/29?)
//image::reports-main-page.png["List of reports on the Reports page"]
...
* Switch environments.
* Select a time range for the reports.
//TODO: VERIFY APP LINK IMPLEMENTATION IN HYPERFORCE
...
[NOTE]
*Classic Monitoring* mode on US and EU clouds support hybrid applications. You can view data only on the *Requests*, *Performance*, and *Failures* tabs. CPU and memory utilization data isn't available for hybrid applications.
