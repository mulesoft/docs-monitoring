...
You can use OpenSearch Query Domain-Specific Language (Query DSL) to create a filter. To learn the basics, see https://docs.opensearch.org/3.3/query-dsl/[Query DSL] in the v3.3 OpenSearch documentation. 
