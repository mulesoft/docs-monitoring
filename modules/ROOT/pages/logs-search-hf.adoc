...
You can use OpenSearch Query Domain-Specific Language (Query DSL) to create a filter in the JSON format. For information about valid log field identifiers, see <<field-names>>.
