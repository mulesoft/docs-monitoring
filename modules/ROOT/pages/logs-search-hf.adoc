...
** To search across log fields, provide a search term. 
** To search within a selected log field, use TODO_TODO
*** Use whole words.
*** Use a pattern matching in your search, such as `appId: myap*`, or `appId: mya?p`
...
=== Use Operators and Pattern Matching in Log Searches

The Search field accepts some pattern matching symbols (`*`, `?`), logical operators, and arithmetic operators:
