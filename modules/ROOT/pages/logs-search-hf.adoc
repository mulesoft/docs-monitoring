...
+
* To view the full log message with all its fields, click *&gt;* in the *Time* field for a log entry. This action opens a *Table* and *JSON* view. 
** For long, truncated log messages, you can use *Table* view to get full message by clicking the *&gt;* in table's *Message* field.
** You can also use *View surrounding logs* to get context for the log entry, and you can use *View log* to TODO_TODO:TODO.
+
For more information, see TODO_TODO:TODO.
