...
+
You can also negate the top-5 value filter by clicking (*-*). For example, you might use these features to create a filter on a log-level value (*log-level: ERROR*) or negate the value (*NOT log-level: ERROR*).
