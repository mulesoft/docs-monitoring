...
[.notice-banner]
From May through June 2026, Anypoint Monitoring introduces an enhanced xref:log-search-hf.adoc[Log Search experience on the Hyperforce infrastructure] _on a rolling basis_ in the US and EU Cloud instances of Anypoint Platform. This experience will replace the xref:logs-us-eu.adoc[earlier log search experience] over time. When your Log Search experience changes, you can use the Hyperforce version of the Log Search documentation.
