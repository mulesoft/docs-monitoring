...
Log field names in the UI have field identifiers that appear in filter names and saved search labels. Query DSL configurations requires field identifiers.
