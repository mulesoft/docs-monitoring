= Create an Alert for a Custom Dashboard
...
| `Send To` | Email address for each recipient of the alert notification. If you add or change the email address of an alert recipient, they do not receive an email until the alert is triggered.
