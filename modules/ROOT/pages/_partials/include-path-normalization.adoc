...
Parts that don't contain digits or that contain a mix of upper case and lower case characters remain the same. For example, `/booking/abc123/pax/PAisdf` remains `/booking/X/pax/PAisdf`.
