...
API Instance ID::
Instance identifier for an API implementation incorporated into an Omni Gateway (formerly Flex Gateway) or API Gateway runtime
...
[[chart-average-latency-apis]]
include::partial$include-insights-charts.adoc[tag="average-latency"]

//shared Overview metric
[[chart-p95-latency-apis]]
include::partial$include-insights-charts.adoc[tag="p95-latency"]

//shared Overview metric
[[chart-total-requests-volume-apis]]
include::partial$include-insights-charts.adoc[tag="total-requests"]
