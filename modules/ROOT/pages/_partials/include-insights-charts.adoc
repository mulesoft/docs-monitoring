...
Total number of threads for simultaneous requests
+
include::partial$include-insights-charts.adoc[tag="download-as"]
...
+
For information about policies, see xref:api-manager::manage-policies-overview.adoc[]. For permissions, see xref:access-management::permissions-by-product.adoc#api-governance[View Policies] in the Access Management documentation.
