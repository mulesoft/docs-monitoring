...
Runtime Version::
Mule Gateway or Omni Gateway runtime version used by the API implementation 

//TODO: issue: value can be empty; SEE BOOKS API IN STGX 
[[chart-api-instance-id]]
API Instance ID::
Instance identifier for an API implementation incorporated into an Omni Gateway or API Gateway runtime
