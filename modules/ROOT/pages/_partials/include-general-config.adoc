...
[[general_settings]]
*General* tab settings include <<mode_basic, basic>> and <<mode_advanced, advanced>> queries (or modes) for configuring time-series data. Both configurations share fields for the title and a short description.
