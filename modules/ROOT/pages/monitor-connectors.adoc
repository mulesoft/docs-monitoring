...
* CloudHub apps running on Mule 4.1.x, 4.2.0 or later
* CloudHub 2.0 apps running on Mule 4.3 or later

If your app is using Java 17, you must specify the version during deployment. For a list of compatible connectors, see [].
