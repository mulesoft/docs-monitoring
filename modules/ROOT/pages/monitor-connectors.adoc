...
:description: View performance metrics for supported Anypoint connectors in your Mule apps using MuleSoft Anypoint Monitoring and Anypoint Insights.
...
View performance metrics for supported Anypoint connectors in your Mule apps using Anypoint Insights in Anypoint Monitoring.
