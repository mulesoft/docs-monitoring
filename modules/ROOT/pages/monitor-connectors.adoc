...
:description: View performance metrics for supported Anypoint connectors in your Mule apps using Anypoint Monitoring and Anypoint Insights.
:keywords: MuleSoft, Anypoint Monitoring, connector metrics, Anypoint connectors, connector performance, Mule app connectors, Anypoint Insights, connector monitoring
...
// TODO: NEED A NEW LIST OF SUPPORTED CONNECTORS????
NOTE: If your app uses Java 17, you must specify the version during deployment. For a list of compatible connectors, see https://help.salesforce.com/s/articleView?language=en_US&id=000782248&type=1[Java 17 Compatible Anypoint Connectors].

//TODO: IS THIS LIST UP TO DATE?
== Connector Metrics
