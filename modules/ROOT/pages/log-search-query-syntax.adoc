...
To perform a multiple character wildcard search use the * symbol. Multiple character wildcard searches look for zero or more characters. For example, to search for test, tests, or tester, you can use the search:
...
As an example, assume a log search query language index contains two fields--application and message--and message is the default field. If you want to find the result called "The Right Way" which contains the text "don't go this way", you can enter:
