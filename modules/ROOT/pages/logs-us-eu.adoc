...
API Manager and Agent Visualizer provide links to logs for individual agents, brokers, and MCP servers. To search for these logs from Anypoint Monitoring, provide the name of the instance in the search field with any filters to narrow your query.
