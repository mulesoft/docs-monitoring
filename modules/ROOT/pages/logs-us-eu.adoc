...
[.notice-banner]
From May through June 2026, Anypoint Monitoring is rolling out an enhanced Log Search experience on the Hyperforce infrastructure in the US and EU Cloud instances of Anypoint Platform. Over time, this experience will replace the traditional Log Search experience. When your Log Search experience changes, you can begin to use the  xref:monitoring::logs-search-hf.adoc[Hyperforce version of the Log Search documentation].
