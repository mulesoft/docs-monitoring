...
** To find logs for policies applied to agents, brokers, and MCP server, click *Message Logs* from the sidebar, and then click *View logs in Anypoint Monitoring*.
