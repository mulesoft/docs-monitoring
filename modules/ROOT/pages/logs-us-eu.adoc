...
* In Agent Visualizer, click a node in the visual graph, and navigate to logs. For guidance, see xref:agent-visualizer.adoc#access-logs[Access Logs] in the Agent Visualizer documentation.
+
