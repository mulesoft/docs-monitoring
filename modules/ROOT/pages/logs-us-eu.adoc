...
API Manager and {visualizer} provide links to logs for individual agents, brokers, and MCP servers. To search for these logs from Anypoint Monitoring, provide the name of the instance in the search field with any filters to narrow your query.

[IMPORTANT]
--
By default, broker logs don't include reasoning data due to privacy concerns. For troubleshooting purposes, you can enable these logs when deploying the broker. 
