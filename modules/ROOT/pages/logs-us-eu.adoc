...
TODO: VERIFY LIST and IDEALLY DEPLOYMENT TYPES (PABLO AGHEMO: CH1, CH2, Flex logs... Let me get back to you on the rest)
* Mule app and API logs
* Flex Gateway logs
* Message logs from policies applied to agent, MCP server, and LLM instances
...
API Manager and Agent Visualizer provide links to logs for individual agents, brokers, and MCP servers. To search for these logs from Anypoint Monitoring, provide the instance ID for the application or API in the search field with any filters to narrow your query.
...
If your organization opts to enable a broker's reasoning logs, set this property in Runtime Mananger when deploying the broker instance.

In Runtime Manager, set the broker's category field:
