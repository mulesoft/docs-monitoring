...
* In API Manager, navigate to an instance that runs on *Runtime* type Flex Gateway:
** To find Flex Gateway logs, click *Logs* from the sidebar, and then click *View logs in Anypoint Monitoring*.
** To find logs for policies applied to agents, brokers, and MCP servers, click *Message Log* from the sidebar, and then click *View logs in Anypoint Monitoring*.
** For a broker's reasoning logs, click *Message Log* from the sidebar, and then click the button dedicated to the broker. These logs come from the broker application.
