...
API Manager also displays Omni Gateway, message, and broker logs.
////
...
When you search for logs for APIs deployed through Omni Gateway, use the *Application* filter. Use the *App ID* field to identify the instance.
...
NOTE::
Results for the *Application* filter include APIs deployed through Omni Gateway.
