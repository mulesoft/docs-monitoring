...
|===
| Basic Metrics | Unit | Runtime Version Support
| Requests by HTTP Policy Violation | `short` | 4.x-AM only
| Requests by HTTP Respond Code | `short` | 4.x-AM only
| Requests by Method | `short` | 4.x-AM only
| Requests by Instance | `short` | 4.x-AM only
|===
