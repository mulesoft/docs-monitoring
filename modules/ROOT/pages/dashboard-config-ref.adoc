...
|===
| Basic Metrics | Unit | Runtime Version Support
| Requests by HTTP Policy Violation | `short` | 3.x-AM, 4.x-AM
| Requests by HTTP Respond Code | `short` | 3.x-AM, 4.x-AM
| Requests by Method | `short` | 3.x-AM, 4.x-AM
| Requests by Instance | `short` | 3.x-AM, 4.x-AM
|===

[[metrics_advanced]]
=== Advanced Mode

These metrics are available when you use the Advanced mode for applications:
