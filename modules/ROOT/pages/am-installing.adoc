...
To use an earlier version of the agent, see the knowledge article https://help.salesforce.com/s/articleView?id=004576938&type=1[Unable to Download Anypoint Monitoring Agent Installer for Windows after April 1st, 2025 from Anypoint Monitoring UI]. 
