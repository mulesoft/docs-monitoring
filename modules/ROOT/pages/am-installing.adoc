...
[NOTE]
If necessary, you can allowlist the endpoint for outbound firewall rules so your server allows connections. The endpoints to allowlist are listed in xref:am-installing#before-you-begin[Before You Begin].
