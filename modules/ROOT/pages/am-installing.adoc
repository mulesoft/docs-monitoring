...
- If you find connection failure or retry entries, ensure that port 443 in your outbound firewall is open. Older runtimes might still use port 5044 and that needs to be open as well, if that's the case.
