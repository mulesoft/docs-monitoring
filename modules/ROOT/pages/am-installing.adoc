...
In the Mule runtime engine on your server, install a supported version of xref:runtime-manager::runtime-manager-agent.adoc[Anypoint Runtime Manager agent]. 
