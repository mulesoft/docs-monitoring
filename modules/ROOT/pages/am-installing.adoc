...
* To install multiple agent instances, assign a unique port to each agent instance:
+
To set a custom port, use the `-t` parameter when installing. Example: `$ ./install -t 8889`

* To install multiple agent instances as services, assign a unique port and installation name to each agent instance:
