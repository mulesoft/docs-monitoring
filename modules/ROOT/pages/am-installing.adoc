...
Therefore, when you define your property value, for example:

* `/api/V1/proc/payments/{paymentId}/cancel` (single property)
* `/api/V1/proc/order/{orderId},/api/V1/proc/order/{}/cancel` (multiple properties separated by `,`)

All incoming requests matching the pattern:

* `/api/V1/proc/payments/CAjjAXjh/cancel`
* `/api/V1/proc/order/jAXjh`
* `/api/V1/proc/order/jAXjh/cancel`

Normalizes the result as:

* `/api/V1/proc/payments/X/cancel`
* `/api/V1/proc/order/X`
* `/api/V1/proc/order/X/cancel`
