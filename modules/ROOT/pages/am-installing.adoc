...
If the username or password of the SOCKS5 proxy URL contains URI reserved characters, it must be percent-encoded following the encoding rules of RFC 3986.
