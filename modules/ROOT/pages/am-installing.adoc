...
For installer version 3.2.14 or later, you can enable trace data collection for Anypoint Monitoring. On each hybrid server where you want to collect trace data, configure a JVM property and install agent with the trace data collection option.
