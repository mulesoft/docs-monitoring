...
Normalize paths to API endpoints with `anypoint.platform.config.analytics.endpoint.patterns`. This property is useful for paths with dynamic segments. This feature is available for CloudHub and CloudHub 2.
