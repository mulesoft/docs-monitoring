...
* When you install the Anypoint Monitoring agent on a hybrid server in a server group, restart the server in the Runtime Manager UI to enable Anypoint Monitoring to begin collecting metrics.
