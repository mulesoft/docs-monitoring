...
[IMPORTANT]
FIPS isn't certified in xref:release-notes::runtime-manager-agent/runtime-manager-agent-2.7.x-release-notes.adoc#2-7-0[Runtime Manager agent 2.7.x]. If you need to enable FIPS, skip this version.
