...
:description: Install and configure the MuleSoft Anypoint Monitoring agent on on-premises servers to monitor Mule apps in hybrid deployments.
:keywords: MuleSoft, Anypoint Monitoring, hybrid deployment, monitoring agent, on-premises monitoring, agent installation, hybrid setup
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-revdate: August 19, 2026
...
|*Canada*|exchange2-asset-manager-kprod-ca1 |  443
...
|*Japan*|exchange2-asset-manager-kprod-jp1.s3 |  443
...
|*India*|exchange2-asset-manager-kprod-in1 |  443
...
|*Australia*|exchange2-asset-manager-kprod-au1 |  443
|===
...
//TBD: Verify how to confirm the agent is running now that built-in dashboards are removed.
...
- Your metrics fail to export if port 8443 is blocked outbound or if your proxy performs SSL inspection. To address this issue:
+
Verify that outbound traffic to `*.ingest.mulesoft.com:8443` is allowed and that SSL passthrough is enabled on your proxy or firewall. In `mule_ee.log`, the associated issues include:

* `[OkHttp \https://us1.ingest.mulesoft.com:8443/...] Failed to export metrics... timeout`
