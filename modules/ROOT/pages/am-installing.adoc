...
- If you find connection failure or retry entries, ensure that port 443 in your outbound firewall is open. If an older runtime uses port 5044, the port must remain open.
