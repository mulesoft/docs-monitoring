...
* Ubuntu 20.04
* Windows Server 2019 (not currently supported by the 3.x agent installer)
...
* 2.7.x
+
Anypoint Monitoring agent installer version 3.x and higher requires Mule Runtime Manager agent version 2.7.1 or higher. 
* 2.6.x
* 2.5.x
* 2.4.x
* 2.3.0
...
//WAITING FOR IMPLEMENTATION OR OTHER DECISION
//+
//To install an _earlier_ version, such as a 2.x version, you must download the agent's zip file from the *Anypoint Monitoring* tab in the https://help.mulesoft.com/s/downloads?tabset-169e6=38694[download portal]. 
...
[[v3]]
=== Configure Proxy Communication for 3.x Monitoring Agent Installers (HTTP/HTTPS Protocol)

If you proxy your monitoring data as it leaves the data center and you're using a 3.x installer version, the proxy must support the HTTP/HTTPS protocol, and you must configure the Anypoint Monitoring agent to communicate through the proxy.
...
[[v3]]
=== Configure Proxy Communication for 2.x Monitoring Agent Installers (SOCKS5 Protocol)

If you proxy your monitoring data as it leaves the data center and you're using a 2.x version of the Anypoint Monitoring agent installer, the proxy must support the SOCKS5 protocol, and you must configure the Anypoint Monitoring agent to communicate through the proxy.
...
- If you find connection failure or retry entries, ensure that port 8443 (Anypoint Monitoring agent installer version 3.x and later) and 443 (all Anypoint Monitoring agent installer versions) in your outbound firewall are open.
- If you don't find connection failure or retry entries, contact MuleSoft technical support.
