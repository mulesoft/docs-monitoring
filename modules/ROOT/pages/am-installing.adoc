...
include::monitoring::partial$include-traffic-inspection.adoc.adoc[tag=traffic-inspection-overview]

Before you begin:

include::monitoring::partial$include-traffic-inspection.adoc.adoc[tag=traffic-inspection-prereqs]
