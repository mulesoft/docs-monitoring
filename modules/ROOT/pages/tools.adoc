...
+
You can scroll over a connector link to learn more before navigating to Anypoint Exchange. For example, Salesforce connector is for creating tickets in the Salesforce Service Cloud in response to Anypoint Monitoring alert notifications:
+
|==
