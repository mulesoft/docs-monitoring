...
:page-aliases: api-analytics-dashboard.adoc, api-analytics-dashboards.adoc
:note-flex-deployments-not-supported: This metric isn'tn supported for APIs deployed through Omni Gateway (formerly Flex Gateway).
...
[[api-chart-parity]]
== API Chart Mapping (Built-in and Insights Dashboards)
