...
| <<dashboards, Classic Built-in and Custom Dashboards>>
| Yes
| No
| No
| Yes
...
In US and EU clouds, use built-in dashboards or customize your own to provide instant visibility into your apps' performance and detailed analysis of your network.
...
Configure alerts to receive notifications about abnormal behavior and problems in your app network.

You can trigger alert notifications based on thresholds you define for your Mule apps and APIs. 
...
In the US and EU Clouds, generate logs for Mule apps and APIs in real-time and without writing code.
...
In the US and EU Clouds, download warehoused (archived) log data for a Mule app, for example, to help investigate security, compliance, or other issues that logs can reveal.
...
|Advanced metrics for xref:app-dashboards.adoc#inbound-charts[Inbound] and xref:app-dashboards.adoc#outbound-charts[Outbound] charts]
|No
|No
|Yes

|xref:app-dashboards.adoc#flows-charts[Flow charts]
|No
|No
|Yes

|xref:app-dashboards.adoc#connectors-charts[Connector charts]
|No
|No
|Yes

|<<note-visualizer, API Visualizer>>: *Application Network* tab for the API Visualizer app network integration 
|No
|No
|Yes
...
4+| xref:api-dashboard.adoc[Built-in API Dashboards]
...
|xref:api-dashboard.adoc#anypoint-monitoring-archive-api[Anypoint Monitoring Archive API]
|No
|No
|Yes
...
[[classic]]
== Classic and Enhanced Monitoring Features

On EU and US Clouds, classic and enhanced monitoring feature sets are currently available. Clicking *Insights* from the classic Anypoint Monitoring mode opens to Anypoint Insights, provides access to other enhanced monitoring features, and includes a link back to classic monitoring, *Open Classic Monitoring*. 

[%header,cols="a,a"]
|===
| Classic Features (US and EU Clouds) | Enhanced Features (US and EU Clouds)
