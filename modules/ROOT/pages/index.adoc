...
** <<functional-monitoring>>: Anypoint Monitoring provides a link to this feature in Anypoint Platform.
...
Anypoint Monitoring also provides a link to from all regions. 
