...
:visualizer: Anypoint Visualizer
:visualizer-former: (formerly Anypoint Visualizer)
...
|<<note-visualizer, {visualizer}>>: *Application Network* tab for the {visualizer} app network integration 
|No
|No
|Yes
...
NOTE:
--
{visualizer} app network integration refers to features in the *Application Network* tab within Anypoint Monitoring. {visualizer} as a product outside of Anypoint Monitoring is available to organizations regardless of pricing plan. 
--
...
+
IT specialist Peyton uses {visualizer} to view their app network. For CloudHub and Anypoint Runtime Fabric apps, Peyton sees CPU and memory utilization and idle capacity using integrated Anypoint Monitoring.
