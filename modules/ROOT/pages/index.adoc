...
:description: MuleSoft Anypoint Monitoring provides visibility into Mule apps, APIs, and agentic assets through metrics, logs, traces, alerts, and dashboards across Anypoint Platform environments.
:keywords: MuleSoft, Anypoint Monitoring, overview, metrics, logs, traces, alerts, dashboards, Mule apps, APIs, agentic assets, Anypoint Platform
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Anypoint Monitoring provides visibility into the performance, health, and behavior of your Mule apps, APIs, and agentic assets across all Anypoint Platform environments.
...
NOTE: Anypoint Monitoring provides application-level metrics for Mule apps and APIs. VPC-level network traffic and monthly outbound byte totals aren't available. For details on metrics scope and how to estimate traffic using the Metrics API, see xref:am-faq.adoc#vpc-traffic-metrics[Anypoint Monitoring FAQ].
...
| https://ca1.platform.mulesoft.com/monitoring[Canada], https://jp1.platform.mulesoft.com/monitoring[Japan] Clouds
| https://in1.platform.mulesoft.com/monitoring[India] Cloud 
| https://au1.platform.mulesoft.com/monitoring[Australia] Cloud
...
| xref:logs.adoc[Logging features]
| Yes
| Yes
| Yes
| Yes

| xref:tools.adoc[Notifications] (*Tools*)
| Yes
| Yes
| Yes
| Yes
...
Support for logging features can vary by Anypoint Platform cloud. For details, see <<features>>.
...
Search for and review logs from across your deployed applications. 
...
|<<note-visualizer, *Application Network tab*>> for Anypoint Visualizer app network integration data in Anypoint Monitoring 
|No
|No
|Yes
...
|xref:alerts-hf.adoc[Basic alerts] for apps, servers, and APIs
|Yes
|Yes
|Yes, with xref:performance-and-impact.adoc#data-retention-and-aggregation[higher limits]

|xref:dashboard-custom-config.adoc#alerts-custom-dashboards[Alerts for Custom Dashboards]
|No
|No
|Yes
...
|Log search
|Yes (<<single-app, single application only in Runtime Manager>>)
|No
...
|<<archive-api, Anypoint Monitoring Archive API>>
|No
|No
|Yes
...
For more information about this API, see https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/anypoint-monitoring-archive-api/minor/1.0/pages/home/[Anypoint Monitoring Archive API] in Anypoint Exchange.

[[note-visualizer]]
NOTE:
--
API Visualizer (formerly Anypoint Visualizer) app network integration refers to features in the *Application Network* tab within Anypoint Monitoring. API Visualizer as a product outside of Anypoint Monitoring is available to organizations regardless of pricing plan. 
--
...
+
IT specialist Peyton uses API Visualizer to view their app network. For CloudHub and Anypoint Runtime Fabric apps, Peyton sees CPU and memory utilization and idle capacity using integrated Anypoint Monitoring.
...
[[classic]]
== Classic and Enhanced Monitoring Views

On EU and US Clouds, Anypoint Monitoring provides access to features from Classic Monitoring and enhanced views. Clicking a feature, such as *Insights* from the Classic Monitoring view opens to features that are now available from the enhanced view, and includes a link back to Classic Monitoring view, *Open Classic Monitoring*. 

[%header,cols="a,a"]
|===
| Classic Monitoring View Feature List (US and EU Clouds) | Enhanced View Feature List (US and EU Clouds)
