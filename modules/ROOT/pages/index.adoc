...
Log and metric data in the same region as your control plane. The following regions are available:
** US East (N. Virginia)
** EU (Frankfurt)
...
The Titanium subscription significantly increases the storage per vCore over the Base subscription.
