...
|===
| Feature | Gold and Platinum Subscription Features | Titanium Subscription Features | Platinum Subscription for Mulesoft Government Cloud Features
...
|Legacy API Analytics panel in custom dashboards
|Yes
|Yes
|No
...
NOTE: Anypoint Visualizer application network integration refers to an Anypoint Visualizer widget within Anypoint Monitoring. This feature is available only to users who have a Titanium subscription. Anypoint Visualizer outside of Anypoint Monitoring is available to customers of all subscription levels.
