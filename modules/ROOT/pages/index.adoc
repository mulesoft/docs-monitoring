...
* https://anypoint.mulesoft.com/monitoring[US Cloud] and https://eu1.anypoint.mulesoft.com/monitoring[EU Cloud] regions:
...
* https://ca1.mulesoft.com/monitoring[Canada Cloud] and https://ja1.mulesoft.com/monitoring[Japan Cloud] regions:
** <<insights>>
** <<functional-monitoring>>
