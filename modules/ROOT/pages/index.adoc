...
[[features]]
== Monitoring Features by Control Plane Region

Anypoint Monitoring is available in all control plane regions that host Anypoint Platform.  

include::partial$include-nav-entities.adoc[tags="region-data-not-shared"]

* https://anypoint.mulesoft.com/monitoring[US Cloud] and https://eu1.anypoint.mulesoft.com/monitoring[EU Cloud] (Feature availability depends on your <<billing, billing package or plan>>):
...
* https://ca1.platform.mulesoft.com/monitoring[Canada Cloud] and https://jp1.platform.mulesoft.com/monitoring[Japan Cloud] (Only Starter package features are available at this time):
...
For more information about Anypoint Platform clouds, see xref:hosting-home::index.adoc#control-plane-hosting-options[Control Plane Hosting Options].
