...
Anypoint Monitoring is the standard method of monitoring Mule application and API performance, logging, and troubleshooting to reduce the mean time to identify and resolve issues. While all customers receive fundamental monitoring capabilities with their subscription, the Titanium tier offers greater storage, guaranteed resources, and advanced capabilities that allow for greater control and flexibility.

|===
| Feature | Gold/Platinum subscription features | Titanium subscription features

3+| *Built-in Application Dashboards*
|More than 80 out-of-the-box charts covering metrics in the following categories: Overview, Inbound, Outbound, Performance, Failures, JVM, Infrastructure

|Yes
|Yes

|Advanced metrics for Overview, Inbound, Outbound, Performance, Failures, JVM, and Infrastructure charts
|No
|Yes
...
|16 out-of-the-box charts for metrics covering the following categories: Overview, Requests, Failures, Performance, Client Application 
|Yes
|Yes
