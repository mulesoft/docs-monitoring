...
|<<note-visualizer, API Visualizer>> (formerly Anypoint Visualizer): *Application Network* tab for the API Visualizer app network integration 
|No
|No
|Yes
...
[[note-visualizer]]
NOTE: API Visualizer app network integration refers to features in the *Application Network* tab within Anypoint Monitoring. API Visualizer as a product outside of Anypoint Monitoring is available to organizations regardless of pricing plan. 
