...
Anypoint Monitoring feature availability depends on the control plane for your Anypoint Platform instance and your <<billing, usage-based or subscription-based tier>>. 
...
Feature availability depends on the tier of your Anypoint Platform pricing package or plan:
