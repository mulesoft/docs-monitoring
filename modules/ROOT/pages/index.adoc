...
//NOTE:
//Insights and API Functional Monitoring are not supported in Anypoint Platform Private Cloud Edition (Anypoint Platform PCE) or in MuleSoft Government Cloud. 

For more information Anypoint Platform control plane regions, see xref:hosting-home::index.adoc#control-plane-hosting-options[Control Plane Hosting Options].
...
//Rajesh says to retain data-storage-retention
