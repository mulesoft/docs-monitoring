...
Anypoint Monitoring feature availability depends on your control plane region and  <<billing, billing package or plan>>. 
include::partial$include-nav-entities.adoc[tags="region-data-not-shared"]

[%header,cols="3a,1a,1a,1a"]
|===
|Anypoint Monitoring Feature |US & EU Clouds | Canada & Japan Clouds | Government & Private Clouds
...
* xref:tools.adoc[Notifications to external systems]
.^| yes
.^| no
.^| yes

|{empty} 
  <<insights, Anypoint Insights dashboards>>
| yes (Beta)
| yes
| no
...
* US Cloud and EU Cloud (https://anypoint.mulesoft.com/monitoring[US], https://eu1.anypoint.mulesoft.com/monitoring[EU]) offer all monitoring features.

//TEMP INFO: Hyperforce 12/24 (W-17225983)
* Canada Cloud and Japan Cloud (https://ca1.platform.mulesoft.com/monitoring[Canada], https://jp1.platform.mulesoft.com/monitoring[Japan]) features are available in the usage-based <<plans-usage-based, Starter>> package only at this time.
