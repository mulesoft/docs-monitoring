...
For information about specific subscription tiers, see xref:performance-and-impact.adoc#data-retention-limits[Data Retention Limits]. For complete details about pricing, contact your customer support representative. 
...
|<<note-visualizer, Anypoint Visualizer>> app network integration
|No
|No
|Yes
