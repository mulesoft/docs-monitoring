...
[[single-app]]
//single-app logs:
NOTE: More limited log search is available from Runtime Manager for individual Mule apps. You can navigate to Runtime Manager, open the app, and then click *Logs*. 
