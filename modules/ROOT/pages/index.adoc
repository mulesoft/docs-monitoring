...
Feature availability depends on your region and <<billing, billing package or plan>>. include::partial$include-nav-entities.adoc[tags="region-data-not-shared"]
...
* https://ca1.mulesoft.com/monitoring[Canada Cloud] and https://ja1.mulesoft.com/monitoring[Japan Cloud]:
** <<insights>>
** <<functional-monitoring>>
