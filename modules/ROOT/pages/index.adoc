...
** <<functional-monitoring>>: Anypoint Monitoring provides a link to this feature.

* https://ca1.mulesoft.com/monitoring[Canada (CA) Cloud] and https://ja1.mulesoft.com/monitoring[Japan (JP) Cloud] regions:
