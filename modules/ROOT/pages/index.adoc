...
* Stores log and metric data in the same region as your control plane, which can help you to meet data security and compliance requirements, run queries over geo-distributed runtimes without consequence, and limit the distance that your data travels when you run queries. These regions are available:
** US East (N. Virginia)
** EU (Frankfurt)
