...
On EU and US Clouds, access to features from classic and enhanced views are currently available. Clicking a feature, such as *Insights* from the Classic Monitoring view opens to features that are now available in the enhanced view, and includes a link back to Classic Monitoring view, *Open Classic Monitoring*.
