...
[[single-app]]
//single-app logs:
NOTE: Log search limited to individual deployed apps is available in Runtime Manager. You can navigate to Runtime Manager, open the app, and then click *Logs*. For more logging options, see xref:runtime-manager::deployment-strategies.adoc#logging[Logging by Deployment Model].
