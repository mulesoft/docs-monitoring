...
To view builtin dashboards, you must select an environment and a resource (Mule application or API).
...
Note that it is also possible to configure tags for custom dashboards. See xref:dashboard-custom-config.adoc[Configuring Custom Dashboards].
