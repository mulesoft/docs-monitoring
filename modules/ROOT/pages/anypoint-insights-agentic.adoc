...
MCP servers protected by a Omni Gateway (formerly Flex Gateway) ingress policy (xref:gateway-home::index.adoc#policy-availability-by-gateway[MCP Support]) produce metrics in these charts:
