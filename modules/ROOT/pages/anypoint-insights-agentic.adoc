...
MCP servers protected by a Omni Gateway ingress policy (xref:gateway-home::index.adoc#policy-availability-by-gateway[MCP Support]) produce metrics in these charts:
