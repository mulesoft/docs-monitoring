= Managing Anypoint Monitoring Settings
:description: Manage CloudHub and hybrid deployment settings in MuleSoft Anypoint Monitoring, including agent installation, enabling or disabling monitoring for apps, and path normalization configuration.
:keywords: MuleSoft, Anypoint Monitoring, settings, CloudHub settings, hybrid settings, monitoring configuration, agent installation, deployment settings
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Use the Settings page in Anypoint Monitoring to install the monitoring agent, enable or disable monitoring for CloudHub apps, and configure path normalization.
