...
+
The UI displays instructions for installing Anypoint Monitoring on-premises. The UI provides access to the latest version of the Anypoint Monitoring agent (`am.zip`). 
//HIDING FOR NOW:
