...
To use an earlier version, see the knowledge article https://help.mulesoft.com/s/downloads?tabset-169e6=7ea44[Unable to Download Anypoint Monitoring Agent Installer for Windows after April 1st, 2025 from Anypoint Monitoring UI]. 
