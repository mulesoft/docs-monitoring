...
+
The UI displays instructions for installing Anypoint Monitoring on-premises. The UI provide access to the latest version of the Anypoint Monitoring agent (`am.zip`). For earlier versions, you must download the agent from the *Anypoint Monitoring* tab in your customer portal. 
